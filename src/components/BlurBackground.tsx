...
// blur: optional, defaults to 100px. Lower = sharper edges (and slower animation)
...
const circles = [
  ...
  { size: 700, left: '70%', top: '60%', color: 'blue', duration: 14, delay: 0.25, blur: 60, dir: 'ccw', orbitX: 100, orbitY: 90 },
  ...
  { size: 380, left: '60%', top: '20%', color: 'blue', duration: 7, delay: 0.08, dir: 'ccw', orbitX: 110, orbitY: 85 },
  ...
  // Small circles
  { size: 200, left: '15%', top: '80%', color: 'blue', duration: 5, delay: 0.45, dir: 'ccw', orbitX: 70, orbitY: 60 },
  ...
  { size: 100, left: '20%', top: '35%', color: 'blue', duration: 22, delay: 0.05, blur: 35, dir: 'ccw', orbitX: 50, orbitY: 65 },
  ...
  { size: 70, left: '55%', top: '30%', color: 'blue', duration: 3.2, delay: 0.15, dir: 'ccw', orbitX: 40, orbitY: 50 },
  ...
  { size: 45, left: '78%', top: '25%', color: 'blue', duration: 2.5, delay: 0.52, dir: 'cw', orbitX: 30, orbitY: 40 },
  ...
  return (
    <div className="blur-background-container">
      {circles.map((circle, index) => (
        <div
          key={index}
          className={`blur-circle blur-circle-${circle.color === 'purple' ? 'purple' : 'ibm-blue'} blur-circle-orbit-${circle.dir}`}
          style={{
